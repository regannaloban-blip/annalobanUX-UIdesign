...
function ResponsiveViewportGuide() {
  return (
    <div className="pointer-events-none absolute inset-x-0 top-[-220px] z-20 h-[1054px] min-[600px]:max-md:top-[-220px] min-[600px]:max-md:h-[1054px] md:top-[-140px] md:h-[1072px] lg:hidden" aria-hidden="true">
...
function ResponsiveIntro() {
  return (
    <section className="relative mt-[59px] mb-[72px] h-[920px] w-full min-[600px]:max-md:mx-auto min-[600px]:max-md:mt-0 min-[600px]:max-md:h-[1029px] min-[600px]:max-md:w-[598px] md:mt-0 md:h-[1029px] md:w-[775px] lg:hidden">
      <div className="absolute left-0 top-[7px] z-20 flex w-[390px] max-w-none items-start gap-[11px] min-[600px]:max-md:top-[66px] md:top-[112px]">
      ...
      <div className="absolute left-0 top-0 h-[425px] w-full overflow-visible">
        ...
        />
        <div className="absolute left-0 top-[280px] z-10 w-full min-[600px]:max-md:top-[339px] md:top-[365px]">
          ...
          <h2 className="w-fit whitespace-nowrap font-display text-[78px] font-light uppercase leading-[84px] tracking-[-3.12px] text-white min-[600px]:max-md:ml-[196px] md:ml-[196px] md:text-[126px] md:leading-[136px] md:tracking-[-5.04px]">
            Iam ANNa
          </h2>
        </div>
      </div>

      <div className="absolute left-0 top-[526px] flex w-full flex-col items-start min-[600px]:max-md:top-[647px] md:top-[647px]">
        <div className="flex w-full flex-col gap-6 pb-1 pt-2 min-[600px]:max-md:h-[140px] min-[600px]:max-md:flex-row min-[600px]:max-md:items-start min-[600px]:max-md:justify-between min-[600px]:max-md:gap-0 min-[600px]:max-md:pb-0 min-[600px]:max-md:pt-0 md:relative md:h-[140px] md:gap-0 md:pb-0 md:pt-0">
          <MonoText className="ml-[104px] w-full max-w-[296px] font-normal min-[600px]:max-md:order-2 min-[600px]:max-md:ml-0 min-[600px]:max-md:mt-[30.5px] min-[600px]:max-md:w-[359px] min-[600px]:max-md:max-w-none min-[600px]:max-md:pr-8 md:absolute md:left-[416px] md:top-[30.5px] md:ml-0 md:w-[327px] md:max-w-none">
            Shaping clear visual interfaces for thoughtful digital products and the people who use them.
          </MonoText>
          <h2 className="font-display text-[78px] font-light uppercase leading-[84px] tracking-[-3.12px] text-white min-[600px]:max-md:order-1 min-[600px]:max-md:w-fit min-[600px]:max-md:whitespace-nowrap md:absolute md:left-0 md:top-0 md:w-fit md:whitespace-nowrap md:text-[126px] md:leading-[136px] md:tracking-[-5.04px]">
            UX/UI
          </h2>
        </div>
        <div className="flex w-full flex-col items-start text-white min-[600px]:max-md:h-[242px] md:relative md:h-[242px]">
          <h2 className="mb-[-16px] font-buffon text-[84px] font-normal uppercase leading-[85px] text-white md:mb-0 md:h-[122px] md:w-full md:text-[132px] md:leading-[122px]">
            Product
          </h2>
          <div className="flex w-full flex-col items-start whitespace-nowrap min-[600px]:max-md:h-[91px] min-[600px]:max-md:flex-row min-[600px]:max-md:justify-between">
            <div className="order-2 flex flex-col pt-4 font-jakarta text-base font-normal uppercase leading-[25px] text-white min-[600px]:max-md:order-1 min-[600px]:max-md:pt-4 md:absolute md:left-0 md:top-[106px] md:pt-4">
            ...
            <h2 className="order-1 font-display text-[78px] font-light uppercase leading-[84px] tracking-[-3.12px] text-white min-[600px]:max-md:order-2 min-[600px]:max-md:w-fit md:absolute md:left-[189px] md:top-[106px] md:w-fit md:whitespace-nowrap md:text-[126px] md:leading-[136px] md:tracking-[-5.04px]">
              Designer
            </h2>
          </div>
        </div>
...
function About() {
  return (
    <section className="relative ml-auto flex w-full max-w-[1202px] flex-col gap-12 max-md:mt-[6px] max-md:h-[833px] md:max-lg:mt-[9px] md:max-lg:h-[833px] md:max-lg:w-[775px] lg:mt-0 lg:h-[815px]">
      <div
        data-gl-media
        className="absolute right-0 top-[40px] hidden h-[200px] w-[200px] overflow-hidden bg-white max-md:block md:max-lg:right-0 md:max-lg:top-[40px] md:max-lg:block md:max-lg:h-[239px] md:max-lg:w-[239px]"
      >
        <img src={aboutPortrait} alt="Anna Loban portrait" className="h-full w-full object-cover" />
      </div>
      <div className="flex w-full gap-[21px] max-md:absolute max-md:left-0 max-md:top-[184px] max-md:w-[402px] max-md:gap-4 md:max-lg:absolute md:max-lg:left-0 md:max-lg:top-[208px] md:max-lg:w-[775px] md:max-lg:gap-4 lg:absolute lg:left-[181px] lg:top-[240px] lg:w-[1021px] lg:gap-4">
        <div className="relative mt-[6px] block h-[31px] w-[28px] shrink-0 max-md:mt-0 md:max-lg:mt-0 md:max-lg:w-[84px] lg:mt-0 lg:w-[84px]">
          <img src={quoteIcon} alt="" className="h-[25px] w-[28px] max-md:mt-[6px] md:max-lg:absolute md:max-lg:left-[49px] md:max-lg:top-[6px] md:max-lg:mt-0 lg:absolute lg:left-[49px] lg:top-[6px] lg:mt-0" />
        </div>
        <div className="flex min-w-0 flex-1 flex-col gap-[88px] max-md:w-[358px] max-md:flex-none max-md:gap-[91px] md:max-lg:gap-[91px] lg:gap-[91px]">
          <div className="font-jakarta text-[18px] font-normal uppercase leading-[29px] text-white max-md:text-[20px] max-md:leading-[32px] md:max-lg:!text-[26px] md:max-lg:!leading-[41px] md:text-[32px] md:leading-[49px] lg:text-[26px] lg:leading-[41px]">
            <div
              data-gl-media
              className="float-right mb-2 ml-5 mt-[-120px] h-[180px] w-[180px] overflow-hidden bg-white max-md:hidden md:ml-7 md:mt-[-198px] md:h-[264px] md:w-[264px] md:max-lg:hidden md:mt-[-210px] md:h-[300px] md:w-[300px] lg:mb-0 lg:ml-6 lg:mr-[28px] lg:mt-[-174px] lg:h-[239px] lg:w-[239px]"
            >
              <img src={aboutPortrait} alt="Anna Loban portrait" className="h-full w-full object-cover" />
            </div>
            <span>About . </span>
            <span className="text-white/60">
              I am a <br className="hidden max-md:block" />
              senior UX/UI <br className="hidden max-md:block md:max-lg:block" />
              designer. Strong product <br className="hidden max-md:block md:max-lg:block" />
          ...
          <div className="flex w-[286px] max-w-full flex-col gap-[42px] max-md:h-[165px] max-md:w-[353px] max-md:pr-6 md:max-lg:h-[165px] md:max-lg:w-[353px] md:max-lg:pr-6 lg:w-[359px] lg:pr-6">
...
function Purpose() {
  return (
    <>
    <section className="relative hidden h-[1319px] w-[775px] md:max-lg:block lg:hidden">
    ...
    <section className="flex w-full flex-col items-end pt-[96px] max-md:mt-0 max-md:h-[1304px] max-md:py-[40px] md:max-lg:hidden lg:mt-0 lg:h-[1403px] lg:py-[72px]">
      <div className="flex w-full flex-col items-start">
        <div className="flex w-full flex-col gap-8 lg:flex-row lg:items-start lg:gap-28">
          ...
          <MonoText className="order-first mt-2 w-[296px] max-w-full self-start font-normal !text-base !leading-[25px] max-md:ml-auto max-md:w-[264px] max-md:max-w-none lg:order-none lg:mt-0 lg:w-[264px] lg:pt-2 lg:!text-base lg:!leading-[25px]">
            A web/UI designer crafting intuitive and engaging digital experiences
          </MonoText>
        </div>
...
function WorksHeading() {
  return (
    <section className="mt-0 flex w-full flex-col gap-2 max-md:h-[353px] max-md:pt-[40px] min-[600px]:max-md:h-[346px] min-[600px]:max-md:py-[40px] md:max-lg:h-[346px] md:max-lg:py-[40px] lg:mt-0 lg:h-[487px] lg:py-[72px]">
      <div className="flex h-[180px] w-full flex-col items-start gap-0 min-[600px]:max-md:h-[84px] min-[600px]:max-md:flex-row min-[600px]:max-md:items-end min-[600px]:max-md:justify-between md:h-[136px] md:flex-row md:items-center md:justify-between lg:h-[154px] lg:gap-8">
        <Display className="!text-[78px] !leading-[84px] !tracking-[-3.12px] md:max-lg:!text-[126px] md:max-lg:!leading-[136px] md:max-lg:!tracking-[-5.04px] lg:!text-[168px] lg:!leading-[154px] lg:tracking-[-6.72px]">some</Display>
        <Display className="!text-[78px] !leading-[84px] !tracking-[-3.12px] md:max-lg:!text-[126px] md:max-lg:!leading-[136px] md:max-lg:!tracking-[-5.04px] lg:!text-[168px] lg:!leading-[154px] lg:tracking-[-6.72px]">of my</Display>
      </div>
      <div className="flex w-full items-center pl-0 min-[600px]:max-md:pl-[140px] lg:pl-[188px]">
        <Display buffon className="w-[1338px] !text-[84px] !leading-[85px] md:max-lg:!w-full md:max-lg:!text-[132px] md:max-lg:!leading-[122px] lg:!text-[175px] lg:!leading-[180.7px] lg:tracking-[1.75px]">
          works
        </Display>
      </div>
    </section>
...
function Works() {
  return (
    <section className="mt-0 flex w-full flex-col gap-[92px] px-4 py-[40px] md:max-lg:w-[775px] md:max-lg:px-0 md:max-lg:py-[40px] lg:mt-0 lg:gap-0 lg:px-0 lg:py-0">
      <div className="flex w-full flex-col gap-[72px] md:max-lg:gap-[72px] lg:gap-0">
        <div className="flex w-full flex-col items-start gap-[72px] lg:h-[710px] lg:flex-row lg:justify-between lg:gap-0 lg:py-[72px]">
          <div className="flex w-full flex-col gap-[72px] md:max-lg:gap-[72px] lg:w-auto lg:flex-row lg:gap-[113px]">
            <ProjectCard work={works[0]} className="md:max-lg:ml-[407px] md:max-lg:w-[368px]" />
            <ProjectCard work={works[1]} className="md:max-lg:w-[368px]" />
          </div>
...
function Footer() {
  ...
  return (
    <section className="relative mt-0 flex w-full flex-col max-md:h-[1162px] max-md:pt-[40px] md:max-lg:h-[1230px] md:max-lg:w-[775px] md:max-lg:pt-[40px] lg:mt-0 lg:h-[874px] lg:pt-[72px]">
      ...
      <div className="mt-[32px] grid w-full grid-cols-1 gap-[40px] pt-6 md:grid-cols-[300px_minmax(0,1fr)] md:gap-10 md:max-lg:!mt-[40px] md:max-lg:flex md:max-lg:h-[912px] md:max-lg:flex-col md:max-lg:gap-[40px] md:max-lg:px-0 md:max-lg:py-6 lg:mt-[40px] lg:h-[460px] lg:grid-cols-[496px_minmax(0,1fr)] lg:gap-[40px] lg:p-6">
        <div data-gl-media className="relative order-2 h-[412px] w-[496px] max-w-full overflow-hidden md:order-1 md:h-[300px] md:w-[300px] md:max-lg:!order-2 md:max-lg:!h-[412px] md:max-lg:!w-full lg:h-[412px] lg:w-[496px]">
          <img
            src={footerFormImage}
            alt=""
            aria-hidden="true"
